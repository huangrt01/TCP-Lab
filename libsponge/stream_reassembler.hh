...
class StreamReassembler {
  private:
    ...
    // size_t MaxindexInByteStream; // in-order byte stream 中最大的编号 + 1
    size_t _nextAssembled_idx;
    std::map<size_t, std::string> unreassmbler_str;
    size_t byteSizeInunreassmble;
    size_t isEof_idx; 
